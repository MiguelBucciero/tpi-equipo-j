<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MenuEntrenador.aspx.cs" Inherits="TPI_equipo_J.MenuEntrenador" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-area">
        <ul class="nav nav-tabs" id="mainTabs" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="alumnos-tab" data-bs-toggle="tab" href="#alumnos" role="tab" aria-controls="alumnos" aria-selected="false">Alumnos</a>
            </li>
        </ul>
    </div>
    <div class="tab-content" id="mainTabContent">
        ...
        <div class="tab-pane fade" id="alumnos" role="tabpanel" aria-labelledby="alumnos-tab">
            <h3>Alumnos</h3>
            <p>Contenido de la sección de alumnos.</p>
            <!-- Contenido de la sección de alumnos -->
        </div>
    </div>
</asp:Content>
